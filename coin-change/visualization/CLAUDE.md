...
| **virality**               | `/virality`               | Watch-time & return-viewership overlays: progress bar, step counter, CTA, re-engagement challenge |
| **youtube-metadata**       | `/youtube-metadata`       | Complete YouTube upload metadata: title, description, chapters, tags, settings, end screens, cards, pinned comment |
